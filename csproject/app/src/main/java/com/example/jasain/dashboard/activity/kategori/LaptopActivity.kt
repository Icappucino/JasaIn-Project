...
class LaptopActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        namaToko = arrayOf(
            "Servis Laptop Nusantara",
            "Laptop Expert",
            "Teknisi Laptop Terpercaya",
            "Laptop Care Center",
            "Warung Laptop",
            "Solusi Laptop Nusantara",
            "Bengkel Laptop Indonesia"
        )
        ratingToko = arrayOf(
            "4.7/5",
            "4.7/5",
    ...
    private fun getUserdata(){
        ...
        adapter.setOnItemClickListener(object : KategoriAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                val intent = Intent(this@LaptopActivity, DetailActivity::class.java)

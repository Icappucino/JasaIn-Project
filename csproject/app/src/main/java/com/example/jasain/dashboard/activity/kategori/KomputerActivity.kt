...
class KomputerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        namaToko = arrayOf(
            "Serba Komputer Indonesia",
            "Komputer Sejati",
            "Sentra Teknologi",
            "Bengkel Komputer Nusantara",
            "Cahaya Teknologi",
            "Pusat Servis Komputer",
            "Solusi Komputer Nusantara"
        )
        ratingToko = arrayOf(
            "4.7/5",
            "4.7/5",
    ...
    private fun getUserdata(){
        ...
        adapter.setOnItemClickListener(object : KategoriAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                val intent = Intent(this@KomputerActivity, DetailActivity::class.java)

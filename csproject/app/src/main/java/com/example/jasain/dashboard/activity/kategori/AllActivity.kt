...
class AllActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        namaToko = arrayOf(
            "Service Laptop Kang Salman",
            "Service Laptop Sejahtera",
            "Service Laptop Bapak Burhan",
            "Service Laptop Bapak Andri",
            "Service Laptop Amanah Selalu",
            "Service Laptop Bapak Yuda",
            "Service Laptop Kang Dono"
        )
        ratingToko = arrayOf(
            "4.7/5",
            "4.7/5",
...
//                Toast.makeText(this@AllActivity, "You click on this. $position",Toast.LENGTH_SHORT).show()
            }
        })
    }
}